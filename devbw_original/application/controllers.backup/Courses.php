...
// 	public function other_discount ($id = NULL) // course_id
// 	{
// 		if ($id) {
// 			$this->data['course'] = $this->courses_m->get($id);
// 			!is_null($this->data['course']) || $this->data['errors'][] = 'course could not be found';
// 		}
// 		else {
// 			$this->data['course'] = $this->courses_m->get_new();
// 		}
...
// 		if ($this->form_validation->run() == TRUE) {
// 			$data = $this->courses_m->array_from_post(array(
// 				'registration_fee_off','accommodation_fee_off','arrival_off'
// 			));
// 			$data['made_by'] = $this->session->userdata('id');
// 			$this->courses_m->save($data, $id);
// 			redirect('courses');
...
// 		$this->data['subview'] = 'admin/courses/edit_discount';
// 		$this->load->view('admin/_layout_main', $this->data);
// 	}
