...
<p>From 12th February, twe added £20 p/w supplement applied to all homestay bookings for under 18. (All international students in Canada must have insurance)</p>
<!-- Google tag (gtag.js) -->
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="user-header bg-light-blue">
                                    <img src="<?php echo $this->config->item('base_url2').'img/'.$this->session->userdata('img'); ?>" class="img-circle" alt="User Image" />
                                    <p>
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?php echo base_url().'user/edit/'.$this->session->userdata('id'); ?>" class="btn btn-default btn-flat">Profile</a>
                                    </div>
                    ...
                    <ul class="sidebar-menu" style="display: block !important">  
                        ...
                        <?php  if($user_group->clients == 1) {?>
                            <li style="position: relative;">
                                ...
                                <div id="notesnum">
                                    <?php if ($mynotesnum) { ?>  <span class="displaynotifnum"> <?php echo $mynotesnum; ?> </span> <?php } ?> 
                                </div>
                            </li>
                        <?php } ?>
                        ...
                        <?php  if($user_group->courses == 1) {?>
                            <li>
                                <?php echo anchor('courses', '<i class="fa fa-leanpub"></i> <span>Courses</span>'); ?>
                            </li>
                        <?php } ?>
