<section class="content-header">
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="row">
                ...
                <div class="col-xs-6">
                    <div class="box">
                        ...
                        <div class="box-body table-responsive no-padding" id="course_input">
                            <form action="<?php echo site_url('fees_calculator/submit'); ?>" method="POST"
                                enctype="multipart/form-data" id="myFormgetmypdfclient">

                                <div class="box-body" style="/*height: 80vh;overflow-y:scroll;*/">
                                    <h4 class="box-title ersbdtt1">Course options</h4>

                                    <div id="cropterrors"></div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Region</label>
                                        <div style="font-size: 11px;font-weight: bold;color: red;margin-bottom: 10px;">
                                            It's very IMPORTANT to select the region otherwise all calculations will be
                                            wrong!!!!!!</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="input-group">
                                                <span class="input-group-addon lftbr1"><i class="fa fa-birthday-cake"></i></span>
                                                <span class="input-group-addon lftbr1">Age </span>
                                                    <?php echo form_input(array('class' => 'form-control', 'id' => 'studentage', 'disabled' => 'disabled')); ?>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <div class="form-group" id="course_start_id">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <div class="form-group" id="course_weeks_id">
                                                ...
                                                <select name="slc_couse_weeks2" class="form-control"
                                                    onchange="course_weeks_onchange(this);" id="slc_couse_weeks2"
                                                    style="display:none">
                                                    <option value="" selected="selected">- - Please Select X - -</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <label for="exampleInputEmail1">Others Options</label>

                                        </div>
                                        
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            
                                            <label class='others_cours_options'>
                                                <?php echo form_checkbox(array('name' => 'options_addons', 'value' => 'addons', 'onchange' => "options_onchange(this, 'course_addons_options', 'addons_title')", 'class' => 'others_options', 'id' => 'options_addons')); ?>
                                                <label for="options_addons">Addons</label>
                                            </label>
                                            <br />
                                            
                                            <label class='others_cours_options'>
                                                <?php echo form_checkbox(array('name' => 'options_family', 'value' => 'family', 'onchange' => "options_onchange(this, 'course_family_options', 'family_title')", 'class' => 'others_options', 'id' => 'options_family')); ?>
                                                <label for="options_family">Family</label>
                                            </label>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            ...
                                            <label class='others_cours_options'>
                                                <?php echo form_checkbox(array('name' => 'options_exam', 'value' => 'exam', 'onchange' => "options_onchange(this, 'course_exam_options', 'exam_title')", 'class' => 'others_options', 'id' => 'options_exam')); ?>
                                                <label for="options_exam">Exam Preparation</label>
                                            </label>
                                            <br />
                                            
                                            <label class='others_cours_options'>
                                                <?php echo form_checkbox(array('name' => 'options_professional', 'value' => 'professional', 'onchange' => "options_onchange(this, 'course_professional_options', 'professional_title')", 'class' => 'others_options', 'id' => 'options_professional')); ?>
                                                <label for="options_professional">Professional</label>
                                            </label>
                                    ...
                                    <!-- Start Addons -->
                                    <div id="course_addons_options" class="off">
                                        <div class="clear"></div>
                                        <h4 class="box-title ersbdtt1">Addons Options</h4>
                                        
                                        <div class="row">

                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group" id="course_addons_id">
                                                    <label for="exampleInputEmail1">Course Add-ons</label>
                                                    <?php echo form_dropdown('course_addons_id', $courses_addons_all, set_value('course_addons_id', ''), 'class="form-control" onchange="course_addons_onchange(this);" id="slc_course_addons" disabled'); ?>
                                                </div>
                                            </div>

                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group" id="course_addons_weeks">
                                                    <label for="exampleInputEmail1">Number of Weeks</label>
                                                    <?php echo form_dropdown('slc_course_addons_weeks', $weeks_all, set_value('slc_course_addons_weeks', ''), 'class="form-control" disabled onchange="course_addons_weeks_onchange(this);" id="slc_course_addons_weeks" '); ?>

                                                    <select name="slc_course_addons_weeks2" class="form-control"
                                                        onchange="course_addons_weeks_onchange(this);" id="slc_course_addons_weeks2"
                                                        style="display:none">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group" id="addons_start_id">
                                                    <label for="exampleInputEmail1">Start Date</label>
                                                    <div class="input-group">
                                                        <?php echo form_input(array('name' => 'date', 'value' => set_value('date', ''), 'onchange' => 'course_addons_start_onchange(this)', 'class' => 'form-control course_addons_start', 'disabled' => 'disabled', 'id' => 'datepicker-autoclose', 'data-date-format' => 'yyyy-mm-dd', 'autocomplete' => 'off')); ?>
                                                        <span class="input-group-addon lftbr1"><i class="fa fa-calendar"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <!-- Start Family -->
                                    <div id="course_family_options" class="off">
                                        <div class="clear"></div>
                                        <h4 class="box-title ersbdtt1">Family Options</h4>

                                        <div class="row">

                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group" id="course_family_id">
                                                    <label for="exampleInputEmail1">Course Family</label>
                                                    <?php echo form_dropdown('course_family_id', $courses_family_all, set_value('course_family_id', ''), 'class="form-control" onchange="course_family_onchange(this);" id="slc_course_family" disabled'); ?>
                                                </div>
                                            </div>
                                            
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group" id="course_family_weeks">
                                                    <label for="exampleInputEmail1">Number of Weeks</label>
                                                    <?php echo form_dropdown('course_family_weeks', $courses_family_weeks_all, set_value('course_family_weeks', ''), 'class="form-control" onchange="course_family_weeks_onchange(this);" id="slc_course_family_weeks" disabled'); ?>
                                                </div>
                                            </div>
                                    ...
                                    <!-- Start Exam -->
                                    <div id="course_exam_options" class="off">
                                        <div class="clear"></div>
                                        <h4 class="box-title ersbdtt1">Exam Preparation Options</h4>
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                                <div class="form-group" id="course_exam_id">
                                                    <label for="exampleInputEmail1">Course Exam Preparation</label>
                                                    <?php echo form_dropdown('course_exam_id', $courses_exam_all, set_value('course_exam_id', ''), 'class="form-control" onchange="course_exam_onchange(this);" id="slc_course_exam" disabled'); ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group" id="course_addons_weeks">
                                                    <label for="exampleInputEmail1">Number of Weeks</label>
                                                    <?php echo form_dropdown('slc_course_exam_weeks', $courses_exam_weeks_all, set_value('slc_course_exam_weeks', ''), 'class="form-control" disabled onchange="course_exam_weeks_onchange(this);" id="slc_course_exam_weeks" '); ?>
                                                </div>
                                            </div>
                                            

                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group" id="course_exam_dates">
                                                    <label for="exampleInputEmail1">Start Date</label>
                                                    <?php echo form_dropdown('slc_course_exam_dates', $courses_exam_dates_all, set_value('slc_course_exam_dates', ''), 'class="form-control" disabled onchange="course_exam_weeks_onchange(this);" id="slc_course_exam_dates" '); ?>
                                                </div>
                                            </div>
                                    ...
                                    <!-- Start Professional -->
                                    <div id="course_professional_options" class="off">
                                        <div class="clear"></div>
                                        <h4 class="box-title ersbdtt1">Professional Options</h4>
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                                <div class="form-group" id="course_professional_id">
                                                    <label for="exampleInputEmail1">Course Professional</label>
                                                    <?php echo form_dropdown('course_professional_id', $courses_professional_all, set_value('course_professional_id', ''), 'class="form-control" onchange="course_professional_onchange(this);" id="slc_course_professional" disabled'); ?>
                                                </div>
                                            </div>

                                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group" id="course_professional_dates">
                                                    <label for="exampleInputEmail1">Start Date</label>
                                                    <?php echo form_dropdown('slc_course_professional_dates', $courses_professional_dates_all, set_value('slc_course_professional_dates', ''), 'class="form-control" disabled onchange="course_professional_dates_onchange(this);" id="slc_course_professional_dates" '); ?>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group" id="accommodation_weeks_id">
                                        <label for="exampleInputEmail1">Accommodation weeks<span id="accwkstmd"
                                                style="color: red;margin-left: 10px;font-weight: normal; display:none;">
                                                Must be equol or less than course weeks number </span></label>
                                    ...
                                    <div class="form-group" id="insurance_id">
                                        <label for="exampleInputEmail1">Courier fee - Must add for I-20 delivery fee for
                                            USA F1 visa or Custodianship letter from Canada</label>
                        ...
                        <div class="box-body table-responsive no-padding" id="client_input">
                            ...
                            <label for="exampleInputFile"> Client picture <span style="color:red">allowed type jpg,png
                                </span></label><br>
                            <div class="hpgerpho">
                            ...
                            <div class="form-group">
                                ...
                                <p class="help-block" style="color:red">Put all your certificates in rar or zip file
                                    than upload it</p>
                            </div>
                            <div class="form-group">
                ...
                <div class="col-xs-6">
                    ...
                    <div class="box quotebckcl1" style="/*height: 85vh;overflow-y: scroll;*/">
                        ...
                        <div class="box-body table-responsive no-padding">
                            ...
                            <div class="qtdiv43">
                                ...
                                <h4 class="box-title ersbdtt2">Center</h4>
                                <div class="cal_country_name"></div>
                                <div class="cal_city_name"></div>
                                <div class="cal_centre_name"></div>

                                <h4 class="box-title ersbdtt2" id="firstblock" data-cousetype="0" data-coursestart="0"
                                    data-ercourseid="0" data-courseweek="0" data-courseprice="0" data-regifee="0"
                                    data-currencyname="" data-currencyprice="">Course</h4>
                                ...
                                <div>
                                    <h6 id="addons_title" class="option_title off">Addons</h6>
                                    <div class="cal_course_addons_name"></div>
                                    <div>
                                        <span class="cal_course_addons_weeks"></span>
                                        <span class="flt_right cal_course_addons_price"></span>
                                    </div>
                                </div>
                                
                               <div>
                                    <h6 id="family_title" class="option_title off">Family</h6>
                                    <div style="display: flex;flex-direction: row;justify-content: space-between;gap: 20px;">
                                        <span class="cal_course_family_name"></span>
                                        <span class="flt_right cal_course_family_price"></span>
                                    </div>
                               </div>

                                <div>
                                    <h6 id="exam_title" class="option_title off">Exam</h6>
                                    <div style="display: flex;flex-direction: row;justify-content: space-between;gap: 20px;">
                                        <div class="cal_course_exam_name"></div>
                                        <span class="cal_course_exam_weeks"></span>
                                        <span class="flt_right cal_course_exam_price"></span>
                                    </div>
                                </div>
                                
                                <div>
                                    <h6 id="professional_title" class="option_title off">Professional</h6>
                                    <div style="display: flex;flex-direction: row;justify-content: space-between;gap: 20px;">
                                        <div class="cal_course_professional_name"></div>
                                        <span class="cal_course_professional_weeks"></span>
                                        <span class="flt_right cal_course_professional_price"></span>
                                    </div>  
                                </div>  
                            ...
                            <div style="background:#3D3F44;">
                                <h4 class="box-title ersbdtt2" id="secondblock" data-accoid="0" data-accoweek="0"
                                    data-accoprice="0" data-accofee="0">Accommodation</h4>
                                <hr class="quote_hr1">
                                <div class="qtdiv44 qtdiv441">
                                    ...
                                    <div class="HolderDscAccommoFeePromo vh greenText">
                                        <span class="cal_acco_fee_promo greenText"></span>
                                        <span class="flt_right greenText">
                                            - <span class="cal_acco_fee_promo_price greenText"></span>
                                        </span>
                                    </div>
                                    ...
                                    <div class="accm_sublfls sub2Row vh">
                                        <span class="subtotaltxt1"> Sub Total </span>
                                        <span class="subtotaltxt1 flt_right"><span
                                                class="cal_sub_total_acco sub2Val">00.00</span> </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="qtdiv44">
                                ...
                                <h4 class="box-title ersbdtt2" style="margin-top:2px;" id="thirdblock" data-arriprice="0"
                                    data-deparprice="0" data-insuranceprice="0" data-booksfee="0" data-aramexfee="0">
                                    Optional extras</h4>
                                <hr class="quote_hr1">
                                ...
                                <div class="accm_sublflsse sub3Row vh">
                                    <span class="subtotaltxt1"> Sub Total </span>
                                    <span class="subtotaltxt1 flt_right"><span
                                            class="cal_sub_total_extra sub3Val">00.00</span> </span>
                                </div>
                        ...
                        <div class="box-footer" style="height: 60px;">
                            <button style="display: none;" class="btnsmall12 btn btn-primary link_add_new" id="pdf_quote" onclick="pdf_quote_onclick(this)"> 
                                <i class="fa fa-file-pdf-o"></i> Download
                            </button>
                            <button class="btnsmall12 btn btn-primary link_add_new" id="print_quote" onclick="print_quote_onclick(this)">
        ...
        <!-- Result -->
        <div class="col-xs-12 mt20" style="display: none;">
            <div class="box printdiv" id="printedBlock">
                
                <div class="box-header boheader55">
                    <h3 class="box-title">Result</h3>
                    <button class="btnsmall12 btn btn-primary link_add_new" id="pdf_it"> 
                        <i class="fa fa-file-pdf-o"></i> Download 
                    </button>
                    <button class="btnsmall12 btn btn-primary link_add_new" id="print_it">
                        <i class="fa fa-print"></i>Print 
                    </button>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="colInfo">
                                    ...
                                    <div class="print_course_addons_name" id="prtd_course_addons">
                                        <strong>Course addons:</strong>
                                        <span class="valueCentre cal_course_addons_name"></span>
                                    </div>
                                    <div class="print_course_family_name" id="prtd_course_family">
                                        <strong>Course family:</strong>
                                        <span class="valueCentre cal_course_family_name"></span>
                                    </div>
                                    <div class="print_course_exam_name" id="prtd_course_exam">
                                        <strong>Course exam:</strong>
                                        <span class="valueCentre cal_course_exam_name"></span>
                                    </div>
                                    <div class="print_course_professional_name" id="prtd_course_professional">
                                        <strong>Course professional:</strong>
                                        <span class="valueCentre cal_course_professional_name"></span>
                                    </div>
                                ...
                                <td class="colPrice" style="vertical-align:inherit;position:relative" align="center"
                                    nowrap>
                            ...
                            <tr class="print_summer_supp" id="prtd_course_summer_sup">
                                ...
                                <td class="colPrice" align="center"><span
                                        class="feessummer cal_summer_supp_price"></span></td>
                            </tr>
                            ...
                            <tr class="print_maramex_fees aramexRow" id="prtd_aramex">
                                ...
                                <td class="colInfo"> </td>
                                <td class="colPrice" align="center"><span class="feesaramex cal_aramex_price"></span>
                                </td>
                            </tr>
                            ...
                            <tr class="print_insurance insuranceRow" id="prtd_insurance">
                                ...
                                <td class="colInfo "> </td>
                                <td class="colPrice" align="center"><span class="feesReg cal_insurance_price"></span>
                                </td>
                            </tr>
                            ...
                            <tr class="print_accom" id="prtd_acco">
                                ...
                                <td class="colPrice" style="vertical-align:top;position:relative" align="center">
                                    ...
                                    <div class="greenText"
                                        ...
                                        <div class="HolderDscAccommoFixed HolderDscAccommoFixedAmount vh greenText">
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr id="custodianshipFeeRowPdf" style="display: none;">
                                ...
                                <td class="colInfo "> </td>
                                <td class="colPrice" align="center"><span
                                        class="cfeessummer cal_custodianship_fee_price"></span></td>
                            </tr>
                            ...
                            <tr class="print_accom_fee accommodationFeeRow" id="prtd_acco_fees">
                                ...
                                <td class="colInfo">
                                    <br/>
                                    <div class="HolderDscAccommoFee vh greenText">Accommodation Placement fee waived
                                    </div>
                                </td>
                                <td class="colPrice" align="center">
...
<form method="POST" enctype="multipart/form-data" action="<?php echo site_url('fees/get_pdf'); ?>" id="myFormgetmypdf"
    target="_blank">
...
<script>
    ...
    function print_quote_onclick(sel){
        ...
        var popupUrl = '<?php echo base_url() ?>fees/get_quote?mode=print&data=' + dataString;
        ...
        // Open the popup with the specified URL and dimensions, centered on the screen
        var popup = window.open(popupUrl, 'PopupWindow', 'width=' + width + ',height=' + height + ',left=' + left + ',top=' + top);

        // Trigger the print dialog in the new popup window
        popup.document.close();  // Close the document to ensure it loads

        // Attach the onafterprint event to handle popup closure
        popup.onafterprint = function() {
        // Close the popup when the print dialog is closed (whether printing or canceling)
        popup.close();  // Close the popup after the print dialog is dismissed (either printing or canceling)
        };
    ...
    function pdf_quote_onclick(sel){

        let data = calcul.pdf;
        localStorage.setItem('calculator', JSON.stringify(data));

        let dataString = encodeURIComponent(JSON.stringify(data));
        var popupUrl = '<?php echo base_url() ?>fees/get_quote?mode=pdf&data=' + dataString;
