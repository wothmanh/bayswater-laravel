                                ...
                                <div class="box-body table-responsive no-padding">
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php 
                                                    if($key->type == 0) echo anchor('prices/index/'.$key->id, 'Prices'); 
                                                    else echo anchor('prices/index_ac/'.$key->id, 'Prices', ['title' => 'Prices']); 
                                                ?> 
                                            </td>
                                            <td>
                                                <?php if($key->type == 0) echo anchor('course_discount/index/'.$key->id, 'Course', ['title' => 'Course discount']); else echo anchor('course_discount/index_ac/'.$key->id, 'Course'); ?> 
                                                <br />
                                                <?php echo anchor('fixed_discount/index/'.$key->id.'/'.$school_id, 'Fixed', ['title' => 'Fixed discount']); ?> <br />
                                                <?php echo anchor('other_discount/index/'.$key->id, 'Other', ['title' => 'Other discount']); ?> 
                                            </td>
