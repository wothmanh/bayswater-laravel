                                ...
                                <?php echo form_open_multipart(); ?>
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php echo form_input(array('name' => 'duration', 'value'=> set_value('duration', $courses->duration), 'class' => 'form-control', 'type' => 'number' )); ?>
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Price</label>
                                            <?php echo form_input(array('name' => 'price', 'value'=> set_value('price', $courses->price), 'class' => 'form-control', 'type' => 'number', 'min' => '0' )); ?>
                                        </div>
