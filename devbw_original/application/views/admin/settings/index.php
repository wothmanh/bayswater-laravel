                            ...
                            <div class="box box-primary">
                                ...
                                <?php echo form_open_multipart("settings/index"); ?>
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="allow_description">Allow description</label>
                                            <?php echo form_dropdown('allow_description', $allow_description_all, set_value('allow_description', $settings->allow_description), 'class="form-control"'); ?>
