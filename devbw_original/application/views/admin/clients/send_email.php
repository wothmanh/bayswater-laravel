                                ...
                                <div class="box-header dfsjdd4">
                                    ...
                                    <div class="box-tools">
                                        <span style="float:right">
                                            <button class="btnsmall12 btn btn-primary" data-toggle="modal" data-target="#myModal"> <i class="fa fa-envelope"></i> Send email </button>
                                        </span>
                                    </div>
                                </div><!-- /.box-header -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary"  id="send_emailtall">Send </button>
      </div>
    </div>
  </div>
</div>
                                ...
                                <div class="box-body table-responsive no-padding" id="prntcallby">
                                    ...
                                    <table class="table table-hover" id="clients_table">
                                        ...
                                        <tr>
                                            <td><input type="checkbox" name="sndem[]" value="<?php echo $key->email; ?>" ></td>
