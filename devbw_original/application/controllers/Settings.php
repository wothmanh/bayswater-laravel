...
class Settings extends Admin_Controller
{
	...
	public function index ()
	{
		...
		if ($this->form_validation->run() == TRUE) {
			$data = $this->settings_m->array_from_post(array('websiteName', 'pdf_footer','pdf_title', 'allow_description'));
		...
		$this->data['allow_description_all']["0"] = "No";
		$this->data['allow_description_all']['1'] = 'Yes';
