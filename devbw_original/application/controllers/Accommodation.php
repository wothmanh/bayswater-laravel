...
class Accommodation extends Admin_Controller
{
	...
	public function edit ($id = NULL)
	{
		...
		$this->data['combinable_ons']["0"] = "No";
		$this->data['combinable_ons']['1'] = 'Christmas';
		$this->data['combinable_ons']['2'] = 'Promo';
		$this->data['combinable_ons']['3'] = 'Christmas + Promo';
		...
		if ($this->form_validation->run() == TRUE) {
			$data = $this->accommodation_m->array_from_post(array(
				...
				'promo_combinable', 'promo_christmas', 'promo_price', 'promo_minweeks', 'promo_staysstart', 'promo_staysend', 'promo_receivedbefore', 'file_link'
			));
