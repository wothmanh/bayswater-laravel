        ...
        return new Promise((resolve, reject) => {
            if(sel.value) {
                ...
                .then(function (response) {      
                    [...self.HolderCountryName].map(element => element.innerText=sel.options[sel.selectedIndex].text); 
        ...
        return new Promise((resolve, reject) => {
            if (sel.value) {
                ...
                if(self.mySelections.accommodationWeeks) {
                    accomo_price = self.accommodationPrice;
                } else {
                    accomo_price = 'none';
                }
...
class Calcul extends MyForm {
    ...
    calculate() {
        ...
        if(self.mySelections.courseWeeks) {
            ...
            if(self.mySelections.accommodationWeeks) {
                //console.log('self.accommo_waived = '+self.accommo_waived);
                // accommodation discount
                if(self.accommo_waived != 0) {
                    //self.subSum2T.accommodationPrice = self.subSum2T.accommodationPrice - self.accommo_waived; 
        ...
        let subSum2 = this.getSum(self.subSum2T) + guardAndChrisSum - DiscountSum2T;
